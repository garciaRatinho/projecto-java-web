                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  <li>
                                      <h6>Notificações</h6>
                                      <label class="label label-danger">Notícias</label>
                                  </li>
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              ...
                                              <p class="notification-msg">Até quando este problema de falta de sistema web.</p>
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              ...
                                              <p class="notification-msg">Encontramos solução com sistemas para seus negócios.</p>
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              <h5 class="notification-user">Lídia Manzambi Victor David</h5>
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                 <img src="<%=request.getContextPath() %>/assets/images/gar.jpg" class="img-radius" alt="imagem de perfil do usuário">
