                      ...
                      <div class="pcoded-inner-navbar main-menu">
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <a href="<%= request.getContextPath() %>/Loginservlet?acao=Logout"><i class="ti-layout-sidebar-left"></i>Terminar sessão</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                          <div class="p-15 p-b-0">
                              <form class="form-material">
                                  <div class="form-group form-primary">
                                      ...
                                      <label class="float-label"><i class="fa fa-search m-r-10"></i>Procurar amigos</label>
                                  </div>
                              </form>
                          </div>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Páginas-Menus</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="button.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Butão</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Páginas</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                          ...
                          <div class="pcoded-navigation-label" data-i18n="nav.category.other">Outro</div>
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="pcoded-hasmenu ">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
